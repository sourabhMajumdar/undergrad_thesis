...
from nearest_neighbor_model import Nearest_Neighbor_Model
...
if __name__ == '__main__':
    ...
    excel_file_name = 'Nearest_Neighbor_Results_{}.xlsx'.format(excel_file_sheet_name)
                ...
                for hops in hops_list :
                    for epochs in epochs_list :
                        for memory_size in memory_size_list :
                            ...
                            restaurant_model = Nearest_Neighbor_Model(data_dir=os.path.join(dir_path,"../data/one_data_restaurant_domain/"), 
