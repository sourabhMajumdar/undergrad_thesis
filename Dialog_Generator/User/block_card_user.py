...
class Block_card_user(object) :
    ...
    def perform_random_action(self,bot_action) :
        ...
        if bot_action.get_description() == "SELECT_ACCOUNT" :
            ...
            if bot_action.get_description() == "API_CALL" :
                ...
                accept_key = "block_card_success"
                accept_message = self.templates[accept_key][0]
                
                reject_key = "block_card_failed"
                ...
                if self.state_track["CHANGE_ACCOUNT"] > 2 :
                    self.override = True
                    new_account = random.sample(self.user_account_with_cards,1)[0]
                    self.user["user_account"] = new_account
                ...
                accept_key = "change_card_name_accept"
                accept_message = self.templates[accept_key][0]
                
                reject_key = "change_card_name_reject"
                reject_message = self.templates[reject_key][0]
                ...
                if self.turn_compression :
                    ...
                    accept_key = "change_card_name_accept_turn_compression"
                    accept_message = self.templates[accept_key][0]
                    accept_message = accept_message.format(new_card_name)
                ...
                accept_key = "change_card_id_accept"
                accept_message = self.templates[accept_key][0]
                
                reject_key = "change_card_id_reject"
                reject_message = self.templates[reject_key][0]
                ...
                if self.turn_compression :
                    ...
                    accept_key = "change_card_id_accept_turn_compression"
                    accept_message = self.templates[accept_key][0]
                    accept_message = accept_message.format(new_card_id)
            ...
            elif bot_action.get_description() == "CONFIRM_BLOCK_CARD" :
                actual_actor = "User"
                actual_action = None
                
                accept_key = "confirm_block_card_accept"
                accept_message = self.templates[accept_key][0]
                
                reject_key = "confirm_block_card_reject"
                reject_message = self.templates[reject_key][0]
    ...
    def api_response(self,bot_action) :
        ...
        if bot_action.get_description() == "REQUEST_ACCOUNTS" :
            ...
            user_message = user_message.format(slot_message)
            ...
            if self.user["user_account"] in self.user_account_with_cards :
                ...
                if self.user["user_account"] in self.user["user_accounts"] :
                    ...
                    key = "check_account_failed_no_card"
                ...
                key = "check_account_failed_no_account"
                api_message = self.templates[key][0]
                api_message = api_message.format(slot_message)
