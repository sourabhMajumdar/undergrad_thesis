...
class MemN2NDialog(object):
    ...
    def __init__(self, batch_size, vocab_size, candidates_size, sentence_size, embedding_size,
                 ...
                 session=tf.Session(),
                 name='MemN2N',
                 description="random_memory_network"):
        ...
        self.root_dir = "{}/{}_{}/".format(self.description,'summary_output',timestamp)
    ...
    def _build_inputs(self):
        ...
        self._next_response = tf.placeholder(tf.int32,[None],name="next_user_utterance")
